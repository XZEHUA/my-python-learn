...
BASE_URL = "https://tc.xfei.tech/playground/movie-list-ajax/ZW82o2XTahI_f3vyByc/zh/api/movies"
# ?limit=25&offset=0
headers = {
...
def main():
    ...
    try:
        ...
        movie = collection.find_one({},sort = [("Rating",pymongo.ASCENDING)])
        print("编号：",movie.get("RankPosition"))
        print("评分：",movie.get("Rating"))
    finally:
        client.close()
